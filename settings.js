...
// Other
// Other
global.botname = "KiraiiBOT-Mdོ" //namabot kalian
...
global.packname = '© KiraiiBOT-Mdོ' //sticker wm ubah
global.author = 'Di Buat Oleh KiraiiSenpai' //sticker wm ganti nama kalian
...
global.mess = {
    sukses: 'Yoshaaa , done~',
    admin: 'Untuk Admin Jela Tololl !',
    botAdmin: 'Bagi Bot Admin La Dulu Hadehh !',
    owner: 'Kau Owner Ke Bodo ?',
    group: 'Command Ni Dapat Guna Kat Group Je !',
    private: 'Chat Private La Tololl !',
	bot: 'Fitur Khusus Pengguna Nomor Bot',
    errtoimg: 'Maaf Saat Ini Belum Support Sticker Gif !',
    wait: '⏳ Sedang Di Proses',
	lockCmd: 'Fitur Tidak Diaktifkan Oleh Owner!',
	example1: 'Hii Memek @user Di Group @subject Jangan Lupa Baca Rules @desc\n\nNote :\n1. @user (Mention User Join)\n2. @bio (Get Bio User Join)\n3. @tanggal (Date Now)\n4. @desc (Get Description Group)\n5. @subject (Group Name)'
}
